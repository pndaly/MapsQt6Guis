...
COLORS = [
    ...
    "#FDFDDB", "#E9DBFD", "#FDF0DB", "#FDFDDB", "#F2FDDB", "#E2FDDB", "#DBFDF5", "#DBEFFD",
    "#DBEFED", "#F2FDDB", "#E2FDDB", "#E9DBFD", "#E2FDDB", "#AA0000", "#FF0000", "#00FF00",
    "#0000FF"
]
...
if __name__ == '__main__':
    ...
    _p = argparse.ArgumentParser(description='colors', formatter_class=argparse.RawTextHelpFormatter)
    _p.add_argument('--bg', default=DEFAULT_BG, help="""Background color [%(default)s]""")
    _p.add_argument('--fg', default=DEFAULT_FG, help="""Foreground color [%(default)s]""")
    _a = _p.parse_args()
